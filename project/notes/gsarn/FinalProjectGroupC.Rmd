...
We can also see in the leverage graph that we removed the point with greater leverage and that we do not expect to see any more outliers.$Rivedi questa parte$
...
$$rivedi questa parte perché sto creando un nuovo dataset$$

```{r warning=FALSE, message=FALSE}
#now we create a bigger dataset by concatenating the same dataset (because there are not enough  samples with extreme values of the variable "quality")
d2 = rbind(d_clean.scale,d_clean.scale)
attach(d2)
