...
sds = apply(x_train, MARGIN=2, FUN=sd)
f = function(x) x>means-k*sds & x<means+k*sds
i = x_train[x_train$density == max(x_train$density),] #2240
f(x_train[2240,]) #con k=12 è outlier solo density e infatti si ha
                  #nrow(d_train_clean)=3916
                  #nrow(y_train_light_clean)=3917
```
