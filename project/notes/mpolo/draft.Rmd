...
- models (fai linear regression):
  - gaussian glm (or lm but less cool)
    - tutte variabili moltiplicate l'un l'altre e basta (a+b+..)*(a+b+..)
  - gaussian gam
    - splines
    - ...
  - random forest
...
* gam? è ancora incognita, imo feature selection manuale con AIC se non salta fuori metodo meglio.
