...
```{r}
print(plot_feature_hist(data, "quality","Quality", "#69b3a2"))
```
...
```{r}
print(plot_feature_hist(data, "fixed.acidity","Fixed Acidity", "#69b3a2"))
```
...
```{r}
print(plot_feature_hist(data, "citric.acid","Citric Acid", "#69b3a2"))
```
