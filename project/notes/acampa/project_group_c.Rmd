...
for (i in seq(1, 12, by=4)){
  plot1 <- plot_feature_hist(data, cols[i],cols[i], hist_colors[i]) + theme(plot.margin=unit(c(0,0,0,0),"cm"))
  plot2 <- plot_feature_hist(data, cols[i+1],cols[i+1], hist_colors[i+1]) + theme(plot.margin=unit(c(0,0,0,0),"cm"))
  plot3 <- plot_feature_hist(data, cols[i+2],cols[i+2], hist_colors[i+2]) + theme(plot.margin=unit(c(0,0,0,0),"cm"))
  plot4 <- plot_feature_hist(data, cols[i+3],cols[i+3], hist_colors[i+3]) + theme(plot.margin=unit(c(0,0,0,0),"cm"))
