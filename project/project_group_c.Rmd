...
- GLM can be highly interpretable and is used to show the interactions between our features.
- GAM shows an improvement on the previous model and can capture the non linear effects of the features. It shows that all the observations carry informations relevant to the effectiveness of the models.
- Random Forest shows the best results among our models. It proved to be flexible enough and showed to be able to capture complex interactions among the features.
