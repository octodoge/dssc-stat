...
$$\text{devi togliere una feature al d_light}$$
```{r}
library(mgcv)
...
#On d_light
fit_gam_light = gam( quality ~ s(fixed.acidity) + s(volatile.acidity) + s(citric.acid) + s(residual.sugar) + s(chlorides) + s(total.sulfur.dioxide) + s(free.sulfur.dioxide) + s(pH) + s(sulphates) + s(alcohol), data = d_light, family = gaussian(link = "identity")) 

summary(fit_gam_light)
plot(fit_gam_light)
print(fit_gam_light$aic)


#On d_light_clean
fit_gam_light_clean = gam( quality ~ s(fixed.acidity) + s(volatile.acidity) + s(citric.acid) + s(residual.sugar) + s(chlorides) + s(total.sulfur.dioxide) + s(free.sulfur.dioxide) + s(pH) + s(sulphates) + s(alcohol), data = d_light_clean, family = gaussian(link = "identity")) 
