...
The summary above shows the estimated effect of weight for each color (`Estimate` column, last 3 rows)\
\
Let's test whether this model provides a better fit:
...
Studia capitolo 7.4 prima di procedere

Usa `AIC()` che è più pulito di `summary()`
