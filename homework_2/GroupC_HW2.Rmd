...
Since the alternate hypothesis contains greater than inequality a right-tailed test is performed:
...
p_value=pt(q=2.34, df=91, lower.tail = FALSE)
p_value
```
give a $P$-value of 0.011.
